# №1.3[5]. Вагоны в электричке пронумерованы натуральными числами,
#  начиная с 1
...
if i == j: 
    print ("без дополнительной инф невозможно")
else:
    print(f"кол-во вагонов {i+j-1}")

print("без дополнительной инф невозможно" if i == j  else f"кол-во вагонов {i+j-1}")