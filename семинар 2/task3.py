...
# наблюдений за погодой. Они обратились к синоптикам, а те, в свою 
# очередь, занялись исследованиями статистики за прошлые годы. 
...
num_days = int(input("введите кол-во дней: "))
...
if  1 <= num_days <= 100:
    ...
    while current_day < num_days:
        ...
        if current_temp >= 0:
            lengt_warm += 1
            if current_day == num_days and lengt_warm > max_lengt_warm:
                max_lengt_warm = lengt_warm
        elif lengt_warm > max_lengt_warm:
            max_lengt_warm = lengt_warm
            lengt_warm = 0
print(max_lengt_warm)
